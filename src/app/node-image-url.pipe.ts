...
export class NodeImageUrlPipe implements PipeTransform {
  ...
  transform(value: Node, args = {
    ...
    const id = (value as LearningMaterial).node_ref_id ?? (value as CollectionMaterialsCount).collection_id;
    return environment.eduSharingPath + '/preview?nodeId=' + encodeURIComponent(id) +
